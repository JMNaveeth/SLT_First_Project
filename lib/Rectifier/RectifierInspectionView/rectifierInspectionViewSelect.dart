                      ...
                      if (filteredRemarkDataList == null) {
                        ...
                        return GestureDetector(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              title: Text('Date: ${data.clockTime}', style: TextStyle(color: subTextColor),),
                              subtitle: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  //Text('Region: ${data.region}'),
                                  Text(
                                    '${rectifierDetails!.brand} | (${rectifierDetails.model})', style: TextStyle(color: subTextColor),),
                                  Text(
                                    'Location : ${rectifierDetails.rtom} ${rectifierDetails.station} | (${data.recId})',style: TextStyle(color: subTextColor),),
                                  Text('Shift: ${data.shift}', style: TextStyle(color: subTextColor),),
                                  Text('Checked By: ${data.userName}', style: TextStyle(color: subTextColor),),
                                  Text('Remark: No remark available', style: TextStyle(color: subTextColor),),
                                ],
                              ),
                            ),
                          ),
