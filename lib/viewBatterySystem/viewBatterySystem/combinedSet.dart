...
class _CombinedSetPageState extends State<CombinedSetPage> {
  ...
  Card makeButtonCard(Lesson lesson, String ID) => Card(
        elevation: 8.0,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: makeListTile(
                      lesson.subjectName, lesson.variable), // Text content
                ),
                    ...
                    ? ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20.0,
                              vertical: 10.0), // Adjust button padding
                        ),
                      )
                      ...
                      Column(
                        children: [
                          ...
                          _matchedData.isNotEmpty
                              ? makeButtonCard(
                                  Lesson(
                                      ...
                                      variable: _matchedData[0]["asset_tag"] ??
                                          'N/A'),
                                  _matchedData[0]["asset_tag"])
                              : makeCard(Lesson(
                                  subjectName: 'System ID', variable: 'N/A')),
                          makeCard(Lesson(
                          ...
                          makeCard(Lesson(
                              ...
                              variable: _matchedStations[0]["last_updated"] ??
                                  'N/A')),
                          makeCard(Lesson(
                        ...
                        children: [
                          ...
                          _matchedData.isNotEmpty
                              ? makeButtonCard(
                                  Lesson(
                                      subjectName: 'System ID',
                                      variable: _matchedData[1]["asset_tag"] ??
                                          'N/A'),
                          ...
                          makeCard(Lesson(
                              subjectName: "Last Update",
                              variable: _matchedStations[1]["last_updated"] ??
                                  'N/A')),
                          makeCard(Lesson(
                              subjectName: "Uploader",
                              variable:
                        ...
                        children: [
                          ...
                          _matchedData.isNotEmpty
                              ? makeButtonCard(
                                  Lesson(
                                      subjectName: 'System ID',
                                      variable: _matchedData[2]["asset_tag"] ??
                                          'N/A'),
                          ...
                          makeCard(Lesson(
                              subjectName: "Last Update",
                              variable: _matchedStations[2]["last_updated"] ??
                                  'N/A')),
                          makeCard(Lesson(
                              subjectName: "Uploader",
                              variable:
                        ...
                        children: [
                          ...
                          _matchedData.isNotEmpty
                              ? makeButtonCard(
                                  Lesson(
                                      subjectName: 'System ID',
                                      variable: _matchedData[3]["asset_tag"] ??
                                          'N/A'),
                          ...
                          makeCard(Lesson(
                              subjectName: "Last Update",
                              variable: _matchedStations[3]["last_updated"] ??
                                  'N/A')),
                          makeCard(Lesson(
                              subjectName: "Uploader",
                              variable:
