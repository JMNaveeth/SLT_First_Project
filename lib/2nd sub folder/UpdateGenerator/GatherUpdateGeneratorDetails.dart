...
class GeneratorDetailUpdatePage  extends StatefulWidget {
  ...
  GeneratorDetailUpdatePage({Key? key, required this.generator, required this.updator,required this.brandeng,required this.contBrand,required this.brandset,required this.brandAlt,required this.brandAts,required this.batBrand}) : super(key: key);


  @override
  _GeneratorDetailUpdatePageState createState() => _GeneratorDetailUpdatePageState();
...
class _GeneratorDetailUpdatePageState extends State<GeneratorDetailUpdatePage> {
  ...
  Future<void> _selectDate(BuildContext context, String fieldName) async {
    final currentDate = originalValues[fieldName] != null
          ...
          child: Padding(
                    ...
                    child: Row(
                      children: [
                        const Text(
                          "Province",
                          style: TextStyle(
                              fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor),
                        ),
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: Regions.map((String value) {
                              return DropdownMenuItem<String>(
                                value: value,
                                child: Text(value, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor),),
                              );
                            }).toList(),
                            onChanged: (val) {
                              _onChanged(val, updatedValues, "Province");
                            },
                            style: TextStyle(color: mainTextColor), // Set the dropdown selected text color here
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("Manual",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor),),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("Auto",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor)),
                            ),
                          ],
                        ),
                      ],
            ...
            // Display Location or Manual Entry
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Latitude : ${updatedValues['Latitude'] ?? 'N/A'}",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13,color: mainTextColor),),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Longitude : ${updatedValues['Longitude'] ?? 'N/A'}",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13,color: mainTextColor)),
                        ),
                        if (_isLoading)
                      ...
                      children: [
                        ...
                        Expanded(
                          child: FormBuilderChoiceChips<String>(
                            ...
                            labelStyle: TextStyle(fontSize: 10,color: mainTextColor),
                            spacing: 5,
                            runSpacing: 5,
                            options: const [
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Set Cap"),
                  validator: FormBuilderValidators.compose([
                    FormBuilderValidators.required(),
                  ]),
                  keyboardType: TextInputType.name,
                      ...
                      children: [
                        const Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 13,color: mainTextColor
                          ),
                        ),
                         // Spacer(),
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: [
                              ...
                              DropdownMenuItem<String>(
                                value: "Other",
                                child: Text("Other",style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13,color: mainTextColor),),
                              ),
                            ],
                            onChanged: (val) {
                              if (val == "Other") {
                            ...
                            style: TextStyle(color: mainTextColor), // Set the dropdown selected text color here
                            dropdownColor: suqarBackgroundColor, // Set the dropdown background color here
                            validator: FormBuilderValidators.compose([
                              //FormBuilderValidators.required(),
                            ]),
                          ),
                ...
                CustomTextField(
                  ...
                  onChanged: (val) => _onChanged(val, updatedValues, "Model Alt"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Serial Alt"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) => _onChanged(val, updatedValues, "Model Eng"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Serial Eng"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: [
                              ...brandset.where((String value) => value != "Other").map((String value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value,style: TextStyle(fontWeight: FontWeight.w400,fontSize: 13),),
                                );
                              }).toList(),
                              DropdownMenuItem<String>(
                                value: "Other",
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Model Set"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Serial Set"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Tank Prime"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Day Tank Size"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
              ...
              //   ),
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Rating ATS"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Model ATS"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Feeder Size"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Rating MCCB"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Local Agent"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Agent Addr"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.name,
                ...
                CustomTextField(
                  ...
                  onChanged: (val) =>
                      _onChanged(val, updatedValues, "Agent Tel"),
                  // validator: FormBuilderValidators.compose([
                  //   FormBuilderValidators.required(),
                  // ]),
                  keyboardType: TextInputType.number,
                    ...
                    ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor:
                              ...
                              minimumSize: MaterialStateProperty.all(Size(200, 50)), // Change size (width, height)
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text(
              textTitle,
              style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor),
            ),
            Spacer(),
            Expanded(
              child: FormBuilderTextField(
                ...
                enabled: isWantEdit,
                style: TextStyle(fontWeight: FontWeight.w400, fontSize: 13, color: mainTextColor, // Set the text color here
                ),
                decoration: InputDecoration(
                  border: UnderlineInputBorder(), // Underline border style
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color:mainTextColor), // Border color when enabled
                  ),
                  focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: Colors.blue), // Border color when focused
                  ),
                  contentPadding: EdgeInsets.only(bottom: 0), // Adjust padding if needed
                ),
                onChanged: onChanged,
                validator: validator,
